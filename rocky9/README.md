...
* [Curtin](https://launchpad.net/curtin) >22.1. If you have a MAAS with an earlier Curtin version, you can patch [distro.py](https://code.launchpad.net/~xnox/curtin/+git/curtin/+merge/415604) and [install_grub.py](https://git.launchpad.net/curtin/commit/?id=5b8908216c266445f9374f31bdffd3ba9a0028ba) to deploy Rocky.
